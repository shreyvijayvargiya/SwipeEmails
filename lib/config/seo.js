...
export const SEO_CONFIG = {
	// Homepage
	"/": {
		title: "SwipeEmails — 400+ Email Templates from Top Companies",
		description:
			"400+ hand-picked email templates from Stripe, Notion, Linear, and 100+ more. Search instantly, get the HTML, ship faster.",
		keywords: "email templates, swipe emails, saas email, marketing email, newsletter templates",
		ogImage: "/og-home.png",
		ogType: "website",
	},
	...
	// Features
	"/features": {
		title: "Features - Email templates",
		description:
	...
	// Documentation
	"/docs": {
		title: "Documentation - Email templates",
		description:
			"Complete documentation for Email templates. Learn how to set up, configure, and deploy your SaaS application.",
	...
	// Builder
	"/builder": {
		title: "Build Your Email Templates - Email templates",
		description:
			"Configure your email templates and generate your repository setup. Customize email templates, and deployment settings.",
		keywords: "builder, email templates builder, configuration, setup",
		ogImage: "/og-builder.png",
		ogType: "website",
	},
	// Contact
	"/contact": {
		title: "Contact Us - Email templates",
		description: "Get in touch with us. We're here to help  application.",
	...
	// Admin routes (nested)
	"/admin/*": {
		title: "Admin Dashboard - Email templates",
	...
	"*": {
		...
		keywords: "saas, boilerplate, nextjs, supabase, polar",
		ogImage: "/og-default.png",
		ogType: "website",
	},
};
